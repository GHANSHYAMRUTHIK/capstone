...
@Component({
  selector: 'app-room-availability-component',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './room-availability-component.component.html',
  styleUrl: './room-availability-component.component.css'
})
export class RoomAvailabilityComponentComponent {
  rooms = [
